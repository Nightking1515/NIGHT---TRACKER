...
def option():
    ...
    stderr.writelines(f"""{Gr}
        _   _ ___ ____ _   _ _____     _____ ____      _    ____ _  __
       | \ | |_ _/ ___| | | |_   _|___|_   _|  _ \    / \  / ___| |/ /
       |  \| || | |  _| |_| | | ||_____|| | | |_) |  / _ \| |   | ' /
       | |\  || | |_| |  _  | | ||_____|| | |  _ <  / ___ \ |___| . \
       |_| \_|___\____|_| |_| |_|       |_| |_| \_\/_/   \_\____|_|\_\
{Gr}
              {Wh}[ + ]  C O D E   B Y  N I G H T  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Gr}NIGHT - TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Gr}@CODE BY NIGHT      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
